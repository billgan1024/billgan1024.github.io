	...
	return (
		<>
			...
			<section id="about" className="g1">
				...
				<p className="fade-in-below subdesc">I&apos;m Bill Gan, a student at Milliken Mills High School who has been accepted to Waterloo&apos;s Computer Science program. Here are some of my interests:</p>
